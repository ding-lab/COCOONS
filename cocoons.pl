...
if(!defined($ARGV[1]) || $helpFlag)
{
	print "\nUsage: perl cocoons.pl MAF OUTPUT <OPTIONS>
...
if($mergeFlag)
{
		...
		while(<GTF>)
		{
	        	...
	        	if($l[2] eq "CDS" || $l[2] eq "stop_codon")
        		{
                		...
                		if(! exists $right{$a[3]}{$a[5]})
                		{
                		        $right{$a[3]}{$a[5]}=$l[4];
                		}else
                		{
                		        if($l[4]>$right{$a[3]}{$a[5]})
                		        {
                		                $right{$a[3]}{$a[5]}=$l[4];
                		        }
                		}
		...
		open(GTF, "$gtf");
                while(<GTF>)
                {
                        ...
                        my @a=split(/\"/,$l[8]);
        		next if $l[2] ne "exon";
			next if !exists $left{$a[3]};
			next if !exists $left{$a[3]}{$a[5]};
                        if($l[6] eq "+")
                        {
                                if($l[3]==$left{$a[3]}{$a[5]})
                                {
                                        if($right{$a[3]}{$a[5]}==$l[4])
                                        {
                                                print CDSOUT "$l[0]\t$l[1]\tCDS\t$l[3]\t$l[4]\t$l[5]\t$l[6]\t$l[7]\t$l[8]\n";
                                        }else
                                        {
                                                $tmp=$right{$a[3]}{$a[5]}+1;
                                                print CDSOUT "$l[0]\t$l[1]\tCDS\t$l[3]\t$right{$a[3]}{$a[5]}\t$l[5]\t$l[6]\t$l[7]\t$l[8]\n";
                                        }
                                }else
                                {
                                        if($right{$a[3]}{$a[5]}==$l[4])
                                        {
                                                $tmp=$left{$a[3]}{$a[5]}-1;
                                                print CDSOUT "$l[0]\t$l[1]\tCDS\t$left{$a[3]}{$a[5]}\t$l[4]\t$l[5]\t$l[6]\t$l[7]\t$l[8]\n";
                                        }else
                                        {
                                                $tmp1=$left{$a[3]}{$a[5]}-1;
                                                $tmp2=$right{$a[3]}{$a[5]}+1;
                                                print CDSOUT "$l[0]\t$l[1]\tCDS\t$left{$a[3]}{$a[5]}\t$right{$a[3]}{$a[5]}\t$l[5]\t$l[6]\t$l[7]\t$l[8]\n";
                                        }
                                }
                        }else
                        {
